...
public class AnimalCharacteristicQuiz : MonoBehaviour, IStartable, IMinigameIndex
{
    [Header("Animals components")]
    public List<AnimalDataSO> animals;
    public List<Button> characteristicSpritesButtons;
    public Image animalToComplete;
    ...
    {
        animalToComplete.gameObject.SetActive(active);
    ...
    private void StartNextRound()
    {
        ...
        {
            ShowDialogue("Narrador", "¡Fantástico! Gracias a ti, los animales están completos y listos para continuar su camino en la sabana.");
        ...
        animalToComplete.sprite = _currentAnimal.animalIncompleteSprite;
        ...
        for (int i = 0; i < characteristicSpritesButtons.Count; i++)
        {
            ...
            button.GetComponent<Image>().sprite = animal.animalCharacteristicSprite;
    ...
    {
        string desc = _currentAnimal.animalCharacteristic;
    ...
    private void OnCharacteristicSelected(AnimalDataSO selected)
    {
        ...
        if (selected == _currentAnimal)
        {
            ...
            ShowDialogue("Tim", $"¡Sí, ahí está el {_currentAnimal.animalName}!");
            animalToComplete.sprite = _currentAnimal.animalSprite;
            _isCorrect = true;
